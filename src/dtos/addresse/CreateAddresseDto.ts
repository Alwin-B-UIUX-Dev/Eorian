import { AddresseConstants, type CreateAddresseSchemaType } from '@/constants';
...
export class CreateAddresseDto {
  ...
  constructor(data: unknown) {
    const validated: CreateAddresseSchemaType = AddresseConstants.validateCreateAddresse(data);
