...
export class ProductConstants {
  ...
  // VALIDATION
  public static validationCreateProduct(
    data: unknown
  ...
  //REPONSE
  public static validationResponseProduct(
    data: unknown
...
export type CreateProductSchemaType = z.infer<
  typeof ProductConstants.CREATE_PRODUCT_SCHEMA
>;
export type ResponseProductSchemaType = z.infer<
  typeof ProductConstants.RESPONSE_PRODUCT_SCHEMA
>;
