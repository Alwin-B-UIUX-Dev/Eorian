...
export class Order extends BaseEntity implements IOrder {
  ...
  private subtotalCents: string;
  private taxAmountCents: string;
  private shippingCents: string;
  private totalCents: string;
  ...
  public setShippingAddressId(shippingAddressId: string): this {
    this.shippingAddressId = shippingAddressId;
    this.updateTimestamp();
    return this;
  }
  public setBillingAddressId(billingAddressId: string): this {
  ...
  public setSubtotalCents(subtotalCents: string): this {
    this.subtotalCents = subtotalCents;
    this.updateTimestamp();
    return this;
  }
  public setTaxAmountCents(taxAmountCents: string): this {
    this.taxAmountCents = taxAmountCents;
    this.updateTimestamp();
    return this;
  }
  public setShippingCents(shippingCents: string): this {
    this.shippingCents = shippingCents;
    this.updateTimestamp();
    return this;
  }
  public setTotalCents(totalCents: string): this {
