import { type CreateProductImageSchemaType, ProductImageConstants } from '@/constants';
...
export class CreateProductImageDto {
  ...
  constructor(data: unknown) {
    const validated: CreateProductImageSchemaType =
      ProductImageConstants.validateCreateProductImage(data);
